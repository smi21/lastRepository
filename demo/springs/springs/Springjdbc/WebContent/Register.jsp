...
<head>
  ...
  <!-- ===================== Touch Icons ===================== -->
    ...
    <link rel="apple-touch-"WebContent/Register.html"icon-precomposed" sizes="114x114" href="apple-touch-icon-114-precomposed.png">
  ...
  <body> 
    ...
    <div class="login_main_cont">      
        <div class="login_cont group login">
         ...
         <!--     <h2>Login</h2>  -->  
            ...
            <div class="login_form">
              <form class="formClass" method="post" action="register" onsubmit="return validate();">
              <fieldset>                
                ...
                <fieldset>                
                    ...
                    <input id="username" name="name" class="validate[required] text-input" placeholder="username" type="text" tabindex="1" accesskey="u">                
                </fieldset>
                 
                <fieldset>                
                    <label for="email"><span>Id</span></label>
                    <input id="email id" name="emailid" class="validate[required] text-input" placeholder=" Email ID" type="text" tabindex="1" accesskey="u">                
                </fieldset>
              <!--     <div class="row-fluid">
                      <div class="span">Date:</span></div>
                     <div class="span"><input id="date" type="text" name="dob" placeholder="DOB"><span class="help-inline">99/99/9999</span></div>
                      </div>-->
                ...
                <fieldset class="login_submit"><button type="submit" class="btn">REGISTER</button></fieldset>
        ...
        <div class="login_cont group sign_up">
            ...
            <h2>Sign up</h2>
            <div class="login_form">          
              <form class="formClass" action="register">
                <fieldset>                
    ...
    <script type="text/javascript">
      ...
      function validate()
      {
      	var username=document.getElementById("age");
      
      	
      	var valid=true;
      	if(age.value<18)
      		{
      		alert("Minimun age should be 18");
      		valid=false;
      		}
