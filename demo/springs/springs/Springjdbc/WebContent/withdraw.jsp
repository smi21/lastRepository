  ...
  <body> 
    ...
    <div class="login_main_cont">      
        <div class="login_cont group login">
         ...
         <!--  <h2>Login</h2>       -->      
            <div class="login_form">
              <form class="formClass" method="post" action="withdraw">
                <fieldset>                
                    <label for="accno"><span>accno</span></label>
                ...
                <fieldset class="login_submit"><button type="submit" class="btn">WITHDRAW</button></fieldset>
        ...
        <div class="login_cont group sign_up">
            ...
            <h2>Sign up</h2>
            <div class="login_form">          
              <form class="formClass" action="withdraw">
                <fieldset>                
