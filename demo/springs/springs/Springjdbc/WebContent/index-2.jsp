...
<!-- Mirrored from themes.loxdesign.net/phoenix/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Apr 2016 06:25:07 GMT -->
<head>
                  ...
                  <a class="dropdown-toggle" data-toggle="dropdown" href="#">Profile</a>
                    <ul class="dropdown-menu top_menu">                        
                        <li class="profile group">
                          ...
                          <ul>
                            <li><strong><h6> <% out.print(session.getAttribute("name"));%></h6></strong></li>
                            <li><h6><%out.print(session.getAttribute("d")); %></h6></li>
                            <li><h6><%out.print(session.getAttribute("email")); %></h6></li>
                     ...
                     <!--    <li><a class="mn_profile" href="profile.html"><span>My Profile</span></a></li> -->
                        <li><a class="mn_logout" href="login.jsp"><span>Logout</span></a></li>
                    </ul>
                </li>                          
            </ul>           
          </div>
        ...
        <div class="span3">
          ...
          <div class="side_nav sidebar-nav" data-spy="affix" data-offset-top="150">
            ...
            <ul class="nav nav-list">                          
              <li class="active"><a class="home" href="index-2.jsp">Bank Home Page</a></li>
              <li class="sub">
                <a class="forms" href="#">Operations<span>5</span></a>
                <ul>
             <!--       <li><a href="forms_layout.html">Layout</a></li>
                  ...
                  <li><a href="check_balance.jsp">Check Balance</a></li>
          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">                              
                <li class="active">Home page</li><br></br>
              </ul> 
              <ul class="page_info">
                  <li><h2> WELCOME TO BANK NAME</h2></li>
                ...
                <section>                         
                     <table id="check_2" class="table_basic sortable chbox css">
                        <thead>
                            <tr>
                              <td><input name="chbox" type="checkbox" value=""></td>
                                <td><a class="sort_desc" href="#">Name</a></td>
                                <td><a class="sort_asc" href="#">Id</a></td>
                                <td><a href="#">DOB</a></td>
                                <td><a href="#">Age</a></td>
                        ...
                        <tbody>
                            <tr>
                              <td><input name="chbox" type="checkbox" value=""></td>
                                <td><h6> <% out.print(session.getAttribute("name"));%></td>
                                <td><h6> <% out.print(session.getAttribute("pid"));%></td>
                                <td><h6> <% out.print(session.getAttribute("date"));%></td>
                                <td><h6> <% out.print(session.getAttribute("age"));%></td>
                                <td><h6> <% out.print(session.getAttribute("email"));%></td>
                            </tr>
                         <!--   <tr>
                                <td><input name="chbox" type="checkbox" value=""></td>                                    
                                <td>Row 2</td>
