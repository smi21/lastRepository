        ...
        <div class="login_cont group login">
            ...
            <div class="login_form">
              <form class="formClass" method="post" action="check">
                <fieldset>                
                    <label for="accno"><span>Account ID</span></label>
                    <input id="accno" name="aid" class="validate[required] text-input" placeholder="Account ID" type="text" tabindex="1" accesskey="u">                
                </fieldset>
